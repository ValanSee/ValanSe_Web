...
const OnBoarding = () => {
  return <div className="px-6 py-10">
    ...
    <div className="mb-6">
      ...
      <div className="text-sm border border-gray-300 px-4 py-3 rounded-md">MBTI를 알려주세요</div>
    </div>
    
    <button className="w-full py-4 rounded-md border border-gray-300 mt-8">완료</button>
  </div>
}
