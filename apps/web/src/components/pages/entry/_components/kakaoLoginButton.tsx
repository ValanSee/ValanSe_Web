...
function KakaoLoginButton() {
  ...
  return (
    <button
      type="button"
      onClick={goKakao}
      className="typo-label-02 flex h-14 w-full items-center justify-center gap-2.5 rounded-xl bg-brand-kakao font-semibold text-brand-black hover:brightness-95"
    >
      <Icon icon="ri:kakao-talk-fill" width={20} aria-hidden />
      카카오로 시작하기
    </button>
  )
}
