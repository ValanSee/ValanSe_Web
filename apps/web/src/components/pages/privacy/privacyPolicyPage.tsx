    ...
    <div className="flex min-h-screen flex-col bg-card">
      ...
      <main className="mx-auto w-full max-w-2xl px-4 py-8 leading-relaxed">
        <header className="mb-6">
          <h1 className="typo-heading-03 text-foreground">개인정보 처리방침</h1>
        ...
        <section className="mb-7">
          <h2 className="typo-heading-06 mb-2 text-foreground">
            1. 수집하는 개인정보 항목
          </h2>
          ...
          <p className="typo-body-c-02 mt-2 text-brand-gray-200">
        ...
        <section className="mb-7">
          ...
          <ul className="typo-body-b-01 list-disc pl-5 text-foreground">
        ...
        <section className="mb-7">
          ...
          <p className="typo-body-b-01 text-foreground">
            ...
            다만, 관련 법령에 따라 일정 기간 보관이 필요한 경우 해당 법령에서
            정한 기간 동안 보관할 수 있습니다.
          </p>
          <ul className="typo-body-b-01 mt-2 list-disc pl-5 text-foreground">
            <li>
        ...
        <section className="mb-7">
          ...
          <p className="typo-body-b-01 text-foreground">
            서비스 운영을 위해 아래와 같은 외부 서비스를 이용할 수 있으며,
            필요한 경우 개인정보 처리를 위탁할 수 있습니다.
          </p>
          <ul className="typo-body-b-01 mt-2 list-disc pl-5 text-foreground">
            <li>
        ...
        <section className="mb-7">
          ...
          <ul className="typo-body-b-01 list-disc pl-5 text-foreground">
            ...
            <li>
              서비스 URL:{' '}
              <a href={SERVICE_URL} className="text-primary underline">
                {SERVICE_URL}
              </a>
            </li>
          </ul>
        ...
        <footer className="typo-body-c-02 mt-9 text-brand-gray-200">
